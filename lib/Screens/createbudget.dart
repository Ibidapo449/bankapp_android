...
class _savemeState extends State<saveme> {
                  ...
                  children: [
                                        ...
                                        child: ListView.builder(
                                            ...
                                            itemBuilder: (BuildContext context,
                                              ...
                                              return InkWell(
                                                onTap: () {
                                                  context
                                                      .read<choosefrequency>()
                                                      .showindex(index);
                                                  context
                                                      .read<calculatesavings>()
                                                      .getDaily(index);
                                                  print(index);
                                                },
                                                child: pickfrequency(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  Text(
                                    items[
                                        context.watch<choosefrequency>().index],
                                    style: TextStyle(
                                        fontSize: 20,
                    ...
                    InkWell(
                      onTap: () async {
                        ...
                        final value = newdate.toString();
                        final splithis = value.split(' ')[0];
                        finalmonth = splithis.split('-')[1];
                        finalday = splithis.split('-')[2];
                        finalyear = splithis.split('-')[0];
                        context.read<timepicker>().showindex(
                            finalday, finalmonth, finalyear, newdate);
                        context.read<calculatesavings>().getDate(newdate);
                      },
                      child: Container(
                          height: 60,
                          decoration: BoxDecoration(
  ...
  Container pickfrequency(BuildContext context, int index) {
    final isSeleted = this.context.watch<choosefrequency>().index == index;
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Radio(
            ...
            groupValue: context.watch<choosefrequency>().group,
            onChanged: (value) {
              context.read<choosefrequency>().showindex(value);
              context.read<calculatesavings>().getDaily(value);
            },
          ),
        ],
      ),
  ...
  Container pickdate(BuildContext context, int index) {
    final isSeleted = this.context.watch<choosefrequency>().index == index;
    return Container(
      margin: EdgeInsets.symmetric(
        horizontal: MediaQuery.of(context).size.width * 0.05,
